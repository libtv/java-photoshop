...
import chatServer.Adapter.EnumerationToIterator;
...
public class ChatServerProcessThread extends Thread{
    ...
    public ChatServerProcessThread(Socket socket, ArrayList<UserInfo> userlist, ArrayList<RoomInfo> roomlist) { 
        this.socket = socket;
    ...
    private void broadcast(String data, int type) {
        synchronized (userlist) {
        	...
        	Enumeration<UserInfo> iterators = Collections.enumeration(userlist);
        	EnumerationToIterator iterator = new EnumerationToIterator(iterators);
